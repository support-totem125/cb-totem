...
> Navegación rápida de toda la documentación de Chat-Bot Totem
...
### 🔌 APIs (1 doc)
- [`api/N8N_WORKFLOW.md`](api/N8N_WORKFLOW.md) — Workflow de n8n completo

### 🚢 Despliegue (2 docs)
- [`deployment/MONITOREO_REPOS.md`](deployment/MONITOREO_REPOS.md) — Auto-detect de cambios
- [`deployment/REPO_AUTO_DETECT_README.md`](deployment/REPO_AUTO_DETECT_README.md) — Quick start

### 🔧 Troubleshooting (1 doc)
- [`troubleshooting/TROUBLESHOOTING.md`](troubleshooting/TROUBLESHOOTING.md) — 30+ soluciones

### 📋 Otros (2 docs)
- [`CHANGES.md`](CHANGES.md) — Historial de cambios v2.0
...
1. [01-QUICK_START.md](guides/01-QUICK_START.md) (5 min)
2. [02-INSTALLATION_GUIDE.md](guides/02-INSTALLATION_GUIDE.md) (20 min)
3. [03-CONFIGURATION_GUIDE.md](guides/03-CONFIGURATION_GUIDE.md) (30 min)
4. [TROUBLESHOOTING.md](troubleshooting/TROUBLESHOOTING.md) (cuando necesites)

### 👨‍💻 Desarrollador (1 hora)
1. [ARCHITECTURE.md](architecture/ARCHITECTURE.md) (20 min)
2. [N8N_WORKFLOW.md](api/N8N_WORKFLOW.md) (25 min)
3. [CHANGES.md](CHANGES.md) (10 min)

### 🔧 DevOps (30 min)
1. [MONITOREO_REPOS.md](deployment/MONITOREO_REPOS.md) (15 min)
2. [REPO_AUTO_DETECT_README.md](deployment/REPO_AUTO_DETECT_README.md) (5 min)
3. [TROUBLESHOOTING.md](troubleshooting/TROUBLESHOOTING.md) (cuando necesites)
